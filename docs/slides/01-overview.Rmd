...
A function, an equation

Observations go in, and predictions come out
...
An explanatory or descriptive modeling workflow (show diagrams)
...
A predictive modeling workflow (edited diagrams)

---

Idea: only show huge block of code at beginning, then end, exercise is to figure out what each step does
